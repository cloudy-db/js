...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(19)(Function.call, __webpack_require__(14).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
__webpack_require__(52)($RegExpStringIterator, 'RegExp String', function next() {
...
__webpack_require__(51)(Number, 'Number', function (iterated) {
  this._l = +iterated;
  this._i = 0;
}, function () {
  var i = this._i++;
